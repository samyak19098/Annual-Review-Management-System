...
import {facultyTableList, profileFields, reviewerFormFields, dofaFormFields} from "./HardCode";
...
function InternalReviewerForm(props) {
    ...
    function confirmation(event){
        ...
        Axios.post(`http://localhost:3001/api/updateReview/${queryTable}/${user.id}/${props.match.params.reportId}`, formValues)
            .then(res => {
    ...
    function saveForm(event) {
        ...
        Axios.post(`http://localhost:3001/api/updateReview/saveForm/${queryTable}/${user.id}/${props.match.params.reportId}`, formValues)
            .then(res => {
                // console.log("here man yo!")
                // props.history.push("/assignedReports/");
            })
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="row gutters">
                                            <div className={classes.textfields}>
                                                <TextField disabled={true} id="facultyName" label="Faculty Name" value={facultyDetails.facultyName}  InputProps={{readOnly: true,}}/>
                                            </div>
                                            <div className={classes.textfields}>
                                                <TextField disabled={true} id="emailAddress" label="Email Address" value={facultyDetails.emailAddress}  InputProps={{readOnly: true,}}/>
                                            </div>
                                            <div className={classes.textfields}>
                                                <TextField disabled={true} id="yearOfReport" label="Year Of Report" value={facultyDetails.yearOfReport}  InputProps={{readOnly: true,}}/>
                                            </div>
                                        </div>
                                        <div className="row gutters">
                                            <div className={classes.subheading}>
                                        ...
                                        <div className="row gutters">
                                            <Box component="form" className={classes.box} noValidate autoComplete="off">
                                                <TextField
                                                    ...
                                                    value={formValues.finalInternalRemark}
                                                    multiline
                                                    rows={6}
                                                    maxRows={6}
                                                    onChange={handleChange}
                                        ...
                                        <div className="row gutters">
                                            <div className={classes.button}>
                                                ...
                                                <Button variant="contained" onClick={handleClickSaveOpen}>Save Review</Button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    return (
        renderFields([...dofaFormFields])
    );
}

export default InternalReviewerForm;