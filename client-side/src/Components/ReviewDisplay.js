...
function ReviewDisplay(props) {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:3001/api/formValues/${props.queryTable}/${props.reviewerId}/${props.reportId}`).then((res) => res.json()).then((data) => {
    ...
    function confirmation(event) {
        ...
        Axios.post(`http://localhost:3001/api/finalizeModifiedReview/${queryTable}/${props.reviewerId}/${props.reportId}`, formValues)
            .then(res => {
    ...
    function saveForm(event) {
        ...
        //     queryTable = 'internalReviews';
        // }
        Axios.post(`http://localhost:3001/api/updateModifiedReview/saveForm/${queryTable}/${props.reviewerId}/${props.reportId}`, formValues)
            .then(res => {
                    ...
                    <div className="container">
                        <div >
                            <div className="card-body">
                                ...
                                <div className="row gutters">
                                    {props.status == "False" ? <div className={classes.button}>
                                        <Button variant="contained" onClick={handleClickOpen}>Submit Review</Button>

                                        {/*<div className={classes.button}>*/}
                                        <Button variant="contained" onClick={saveForm}>Save Review</Button>
                                    </div> : <div></div>}
                                    {/*<div className={classes.button}>*/}
                                    {/*    <Button variant="contained" onClick={handleClickOpen}>Submit Review</Button>*/}
